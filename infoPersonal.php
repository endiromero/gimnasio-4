            ...
            <section id="content"><div class="ic"></div>
                ...
                <div class="container_12">
                    <div class="grid_12">
                            ...
                            <br>
                            <br>
                            La Siguiente tabla muestra su Información Personal:
                            <br>
                            <div class="ConsultarInfor2">
                                <img src="images/ejercicio.gif" align=center  width="200" height="170"></div>
                            <br>
                            <div class="panel panel-primary" >
                                ...
                                <table class="table table-hover"> <!-- Lo cambiaremos por CSS -->
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row_DatosUsuarios['Apellido']; ?> </td>
                                        <td><?php echo $row_DatosUsuarios['Edad']; ?> años</td>
                                        <td><?php echo $row_DatosUsuarios['Sexo']; ?></td>
                                        <td><?php echo $row_DatosUsuarios['Direccion']; ?></td>
                                        <td><?php echo $row_DatosUsuarios['Telefono']; ?></td>
                                        <td><?php echo $row_DatosUsuarios['Plan']; ?></td>
